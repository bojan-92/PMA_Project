...
public class MainActivity extends ActionBarActivity {
    ...
    private void getAllWidgets() {
        btnAddNewRecord = (Button) findViewById(R.id.btnAddNewRecord1);

        parentLayout = (LinearLayout) findViewById(R.id.parentLayout1);
        layoutDisplayPeople = (LinearLayout) findViewById(R.id.layoutDisplayPeople1);

        tvNoRecordsFound = (TextView) findViewById(R.id.tvNoRecordsFound1);
    }
    ...
    private void onAddRecord() {
        Intent intent = new Intent(MainActivity.this, TableManipulationActivity1.class);
    ...
    private void displayAllRecords() {
        ...
        if (contacts.size() > 0) {
            ...
            for (int i = 0; i < contacts.size(); i++) {
                ...
                final View view = LayoutInflater.from(this).inflate(R.layout.inflate_record1, null);
                inflateParentView = (LinearLayout) view.findViewById(R.id.inflateParentView1);
